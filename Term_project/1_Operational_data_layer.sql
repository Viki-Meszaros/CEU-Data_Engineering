-- -- -- -- -- -- -- -- -- -- -- CREATE AN OPERATIONAL DATA LAYER -- -- -- -- -- -- -- -- -- -- -- 
--  I used a relational data set called Northwind. It was created by Microsoft and it contains  --
--  the sales data for Northwind Traders , a fictitious specialty foods export­import company   --
--  between 1996-07-04 and 1998-05-06. It has 11 data tables. I imported it with SQL codes and  --
--   not using a csv file of the data.                                                          --
-- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- -- --
